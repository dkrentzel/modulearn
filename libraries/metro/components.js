...
prx.types.metro_button = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '#'+_id+' .metro-button { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+'; line-height: '+(_dims.height-prx.componentsHelper.getProp(item.borderWidth,'num-border-width')*2)+'px; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' '+_props+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; border: '+prx.componentsHelper.getProp(item.borderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; }'
        cR += '</style>';
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);

		cR += '<div class="metro-button-table">'
		cR += '<div class="metro-button liveUpdate-backgroundColor-background-color liveUpdate-textColor-color liveUpdate-borderColor-border-color changeProperty-text changeProperty-backgroundColor changeProperty-textAlign changeProperty-textFont changeProperty-textColor changeProperty-textSize changeProperty-borderWidth changeProperty-borderColor">'
...
prx.types.metro_icon = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .metro-icon { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; border: '+prx.componentsHelper.getProp(item.borderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; }';
        cR += '#'+_id+' .metro-icon-image { background-image: url(' +prx.componentsHelper.getProp(item.imgSrc,'asset')+'); }'
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);

        cR += '<div class="metro-icon liveUpdate-backgroundColor-background-color liveUpdate-borderColor-border-color changeProperty-backgroundColor changeProperty-borderWidth changeProperty-borderColor">';
        cR += '<div class="metro-icon-image"></div>';
        cR += '</div>';
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
        cR = cR + '</div>';
        return cR;
...
prx.types.metro_badge = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        if(item.textProperties === undefined) { item.textProperties = []; }
        ...
        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#'+_id+' .metro-badge-inner { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; }'
        if(prx.componentsHelper.getProp(item.badgeType,'other') == 'glyph') {
            cR += '#'+_id+' .metro-badge-glyph { background-image: url(' +prx.componentsHelper.getProp(item.badgeGlyph,'asset')+'); }'
        }
        cR += '</style>';
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);

        cR += '<div class="metro-badge-inner liveUpdate-backgroundColor-background-color liveUpdate-textColor-color changeProperty-backgroundColor changeProperty-textFont changeProperty-textColor changeProperty-textSize">'
        if(prx.componentsHelper.getProp(item.badgeType,'other') == 'glyph') {
        	cR += '<div class="metro-badge-glyph">';
        }
    ...
    ,propertyGroups: [
        ...
        ,
        {
                ...
                [
                    {
                        ...
                        ,onChange: function(item,name) {
                            if(item.badgeType == 'number') {
                                $('#property-textSize, #property-textFont, #property-textFontStyle, #property-textProperties, #property-textColor').show()
                            } else {
                                $('#property-textSize, #property-textFont, #property-textFontStyle, #property-textProperties, #property-textColor').hide()
                            }
            ...
            [
                ...
                [
                     prx.commonproperties.textFontStyleRichText(['font-weight', 'font-style'], 'badgeNumber', function(item){ return !(item.badgeType == 'number'); }, {propName: 'textFontStyle', caption: 'Font style', useAsDynProp: false}),
                       {
                          caption: false,
                          name: 'textSize',
                          proptype: 'font-size',
                ...
                [
                    prx.commonproperties.textPropertiesRichText(['font-weight','font-style','text-decoration'],'badgeNumber', function(item){ return !(item.badgeType == 'number'); }, {propName: 'textProperties', caption: 'Underline', useAsDynProp: false}),
                    {
...
prx.types.metro_tile_user = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<div class="metro-tile-user-inner liveUpdate-textColor-color">';
...
prx.types.metro_appbar = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#'+_id+' .metro-appbar-inner { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' '+_props+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; }';
        ...
        cR += '<div class="metro-appbar-inner liveUpdate-backgroundColor-background-color changeProperty-backgroundColor liveUpdate-textColor-color changeProperty-textColor changeProperty-textSize changeProperty-textFont">'
    ...
    ,propertyGroups: [
        ...
        },
        {
            ...
            properties: [
                ...
                [
                    prx.commonproperties.textFontStyleRichText(['font-weight', 'font-style'],'buttons.text', false, {propName: 'textFontStyle', caption: 'Button font style', useAsDynProp: false}),
...
prx.types.metro_appbar_mini = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .metro-appbar-mini-inner { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; }';
		cR += '#'+_id+' .metro-appbar-button { width: '+(_dims.height - (20*prx.componentsHelper.getScale(item.lib))) +'px; }';
		cR += '#'+_id+' .metro-appbar-button-icon { border: '+prx.componentsHelper.getProp(item.borderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; }';
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);

		cR += '<div class="metro-appbar-mini-inner liveUpdate-backgroundColor-background-color changeProperty-backgroundColor">'
		$.each(item.buttons, function(i,elm){
			cR += '<div class="metro-appbar-button dynamic-property" data-dynamic-property-index="'+i+'" id="'+_id+'-buttons-'+i+'">';
			cR += '<div class="metro-appbar-button-icon liveUpdate-borderColor-border-color changeProperty-borderWidth changeProperty-borderColor" style="background-image: url(' +prx.componentsHelper.getProp(elm.icon,'asset')+');"></div>';
			cR += '</div>'
		});
		cR += '</div>';
		cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
...
prx.types.metro_charms = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#'+_id+' .metro-charms-outer { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' '+_props+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; }';
        cR += '</style>';
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);

        cR += '<div class="metro-charms-outer liveUpdate-backgroundColor-background-color liveUpdate-textColor-color changeProperty-backgroundColor changeProperty-textColor changeProperty-textSize changeProperty-textFont">'
...
prx.types.metro_filters  = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        if(item.activeTextProperties === undefined) {item.activeTextProperties = item.textProperties;}
        if(item.activeTextFontStyle === undefined) {item.activeTextFontStyle = '400';}
        if(item.activeTextFont === undefined) {item.activeTextFont = item.textFont;}
        ...
        var _activeprops = prx.componentsHelper.getProp(item.activeTextProperties,'props-text');
            _activeprops += prx.componentsHelper.getProp(item.activeTextFontStyle,'props-text-style');
            _activeprops += prx.componentsHelper.getProp(item.activeTextFont + '|' + item.activeTextFontStyle,'font-family');

        if(typeof(item.changeActive) == "undefined") { item.changeActive = true; }

        var cR = "";

        cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-metro-filters liveUpdate-textColor-color">';

        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#'+_id+' {}';
        cR += '#'+_id+' .metro-filter { margin-right: '+prx.componentsHelper.getProp(item.textSize,'num-other')+'px; }'
        cR += '#'+_id+' input:not(:checked) + label span{ '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' '+_props+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; }';
        cR += '#'+_id+' input:checked + label span{'+_activeprops+' color: '+prx.componentsHelper.getProp(item.activeTextColor,'color-text')+'; }';
        cR += '</style>';
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
        ...
        $.each(item.buttons, function(i,elm){
            ...
            if(i == prx.componentsHelper.getProp(item.selected,'num-other')){
                cR += '<input type="radio" name="'+_id+'-radio" id="'+_id+'-radio-'+i+'" checked data-role="none" '+((!prx.componentsHelper.getProp(item.changeActive,'boolean')) ? 'disabled' : '')+'>'
                cR += '<label class="textColor" for="'+_id+'-radio-'+i+'"><span  data-editableproperty="text" class="liveUpdate-activeTextColor-color changeProperty-activeTextColor" data-dynamic-property-index="'+i+'">'+prx.componentsHelper.getProp(elm.text,'text-textarea')+'</span></label>'
            } else {
                cR += '<input type="radio" name="'+_id+'-radio" id="'+_id+'-radio-'+i+'" data-role="none" '+((!prx.componentsHelper.getProp(item.changeActive,'boolean')) ? 'disabled' : '')+'>'
                cR += '<label class="textColor" for="'+_id+'-radio-'+i+'"><span  data-editableproperty="text" class="changeProperty-textColor changeProperty-textFont changeProperty-textFontStyle changeProperty-textProperties changeProperty-textSize liveUpdate-textColor-color" data-dynamic-property-index="'+i+'">'+prx.componentsHelper.getProp(elm.text,'text-textarea')+'</span></label>'
            }
            cR += '</div>'
        });
        //cR += '</div>'
        ...
        },
        {
            ...
            properties: [
                [
                    {
                        caption: { label: 'Font family', class: 'text-properties-label text-fontfamily-label' },
                        name: 'activeTextFont',
                        proptype: 'font-family-2-active',
                        type: 'select',
                        value: function(item, name) {
                            if (typeof(item.activeTextFont) == "undefined") {
                                item.activeTextFont = [];
                            }
                            return item.activeTextFont;
                        },
                        values: function() {
                            return prx.comps.fonts
                        }
                        ,changeProperty: {
                            caption: 'Active text Font',
                            rerender: true
                        }
                    }
                ],
                [
                    {
                        caption: { label: 'Font style', class: 'text-properties-label text-fontstyle-label' },
                        name: 'activeTextFontStyle',
                        proptype: 'font-style-2-active',
                        type: 'select',
                        pffSettings: prx.commonproperties.pffSettingsTextFontStyle,
                        value: function (item, name) {
                            if (typeof(item.activeTextFontStyle) == "undefined") {
                                item.activeTextFontStyle = '400';
                            }
                            return item.activeTextFontStyle;
                        },
                        values: function () {
                            return prx.comps.fontStyles
                        },
                        ...
                        , changeProperty: {
                            caption: 'Active text font Style',
                            rerender: true
                        }
                    }
                    ],
                    [
                    {
                        ...
                        pffSettings: prx.commonproperties.pffSettingsTextProperties,
                        value: function(item, name) {
                            if (typeof(item.activeTextProperties) == "undefined") {
                                item.activeTextProperties = [];
                            }
                            return item.activeTextProperties;
                        },
                        values: [
                            { value: 'underline', displayValue: '', icon: 'text-underline'}
                        ]
                        ,changeProperty: {
                            caption: 'Active underline',
                            rerender: true
                        }
                    },
                        {
...
prx.types.metro_contextmenu = {
    ...
    , onDisplay: function (item, containerid, symbol) {
        ...
        cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol) + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-metro-contextmenu liveUpdate-textColor-color changeProperty-textColor changeProperty-textFont changeProperty-textSize changeProperty-textAlign">';

        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#' + _id + ' { ' + prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle, 'font-family') + ' ' + _props + ' color: ' + prx.componentsHelper.getProp(item.textColor, 'color-text') + '; font-size: ' + prx.componentsHelper.getProp(item.textSize, 'num-text-size') + 'px; text-align: ' + prx.componentsHelper.getProp(item.textAlign, 'align') + '; }';
        cR += '#' + _id + ' .metro-contextmenu-bg { border: ' + prx.componentsHelper.getProp(item.borderWidth, 'num-border-width') + 'px solid ' + prx.componentsHelper.getProp(item.borderColor, 'color-border') + '; ' + prx.gradients.getBgCssByProperty(item.backgroundColor, 'color-background') + '; }';
        cR += '</style>';
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);

        cR += '<div class="metro-contextmenu-bg  liveUpdate-backgroundColor-background-color changeProperty-backgroundColor liveUpdate-borderWidth-border-width liveUpdate-borderColor-border-color changeProperty-borderWidth changeProperty-borderColor">'
        $.each(item.buttons, function (i, elm) {
    ...
    , propertyGroups: [
        {
            ...
            properties: [
                [
                    ...
                    prx.commonproperties.textFontStyleRichText(['font-weight', 'font-style'], 'buttons.text', false, {
                        propName: 'textFontStyle',
                        caption: 'Button font style',
                        useAsDynProp: false
                    }),
                    prx.commonproperties.textSizeRichText('font-size', 'buttons.text')
                ],
                [
                    prx.commonproperties.textPropertiesRichText(['font-weight', 'font-style', 'text-decoration'], 'buttons.text', false, {
                        propName: 'textProperties',
...
prx.types.metro_dropdown_withselection = {
    ...
    , onDisplay: function (item, containerid, symbol) {
        ...
        _dropdownprops += prx.componentsHelper.getProp(item.dropdownTextFontStyle, 'props-text-style');
        ...
        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#' + _id + ' .dropdown-trigger { ' + prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle, 'font-family') + ' ' + _props + ' color: ' + prx.componentsHelper.getProp(item.textColor, 'color-text') + '; font-size: ' + prx.componentsHelper.getProp(item.textSize, 'num-text-size') + 'px; background-image: url(' + prx.componentsHelper.getProp(item.buttonicon, 'asset') + '); }';
        cR += '#' + _id + ' .metro-dropdown-contextmenu { border: ' + prx.componentsHelper.getProp(item.borderWidth, 'num-border-width') + 'px solid ' + prx.componentsHelper.getProp(item.borderColor, 'color-border') + '; ' + prx.gradients.getBgCssByProperty(item.backgroundColor, 'color-background') + ';  }';
        cR += '#' + _id + ' .metro-dropdown-item:not(.active) { ' + prx.componentsHelper.getProp(item.dropdownTextFont + '|' + item.dropdownTextFontStyle, 'font-family') + ' ' + _dropdownprops + ' color: ' + prx.componentsHelper.getProp(item.dropdownTextColor, 'color-text') + '; font-size: ' + prx.componentsHelper.getProp(item.dropdownTextSize, 'num-text-size') + 'px; text-align: ' + prx.componentsHelper.getProp(item.dropdownTextAlign, 'align') + ';}';

        if (prx.componentsHelper.getProp(item.withSelection, 'boolean')) {
            cR += '#' + _id + ' .metro-dropdown-item.active, #' + _id + ' .metro-dropdown-active-value { ' + prx.componentsHelper.getProp(item.activeTextFont + '|' + item.activeTextFontStyle, 'font-family') + ' color: ' + prx.componentsHelper.getProp(item.activeTextColor, 'color-text') + '; ' + _activeprops + ' }'
        }
        cR += '</style>';
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);

        cR += '<div class="dropdown-trigger liveUpdate-textColor-color">'
        cR += '<span data-editableproperty="text">' + prx.componentsHelper.getProp(item.text, 'text-textarea') + '</span>';
        if (prx.componentsHelper.getProp(item.withSelection, 'boolean')) {
            cR += '<span class="metro-dropdown-active-value liveUpdate-activeTextColor-color changeProperty-activeTextColor changeProperty-activeTextFont changeProperty-activeTextProperties changeProperty-activeTextFontStyle changeProperty-activeTextSize liveUpdate-activeTextColor">';
        ...
        cR += '</div>'
        cR += '<div class="metro-dropdown-contextmenu liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color liveUpdate-dropdownTextColor">'
        $.each(item.buttons, function (i, elm) {
            _checked = '';
            if (prx.componentsHelper.getProp(item.withSelection, 'boolean') && i == prx.componentsHelper.getProp(item.selected, 'num-other')) {
                _checked = ' active'
                cR += '<div class="metro-dropdown-item dynamic-property active liveUpdate-activeTextColor-color" id="' + _id + '-buttons-' + i + '" data-dynamic-property-index="' + i + '">';
                cR += '<span data-editableproperty="text" class="changeProperty-activeTextColor changeProperty-activeTextFont changeProperty-activeTextProperties changeProperty-activeTextFontStyle changeProperty-activeTextSize liveUpdate-activeTextColor-color" data-dynamic-property-index="' + i + '">' + prx.componentsHelper.getProp(elm.text, 'text-textarea') + '</span>';
            } else {
                cR += '<div class="metro-dropdown-item dynamic-property" id="' + _id + '-buttons-' + i + '" data-dynamic-property-index="' + i + '">';
                cR += '<span data-editableproperty="text" class="changeProperty-textColor changeProperty-textFont changeProperty-textProperties changeProperty-textFontStyle changeProperty-textSize liveUpdate-textColor-color" data-dynamic-property-index="' + i + '">' + prx.componentsHelper.getProp(elm.text, 'text-textarea') + '</span>';
            }
    ...
    , editableProperties: [
        {
            ...
            , changeProperty: {
                ...
                changeFunction(item, containerid) {
                    ...
                    let cssSelector = '#' + id + ' .metro-dropdown-item .error-msg span';
    ...
    , propertyGroups: [
        {
            ...
            properties: [
                ...
                [
                    prx.commonproperties.textFontStyleRichText(['font-weight', 'font-style'], 'text', false, {
                        propName: 'textFontStyle',
                        caption: 'Font style',
                        useAsDynProp: false
                    }),
                ...
                [
                    prx.commonproperties.textPropertiesRichText(['font-weight', 'font-style', 'text-decoration'], 'text', false, {
                        propName: 'textProperties',
                        caption: 'Underline',
                        useAsDynProp: false
                    }),
            ...
            properties: [
                [
                ...
                ], [
                    {
                        ...
                        proptype: 'font-style-3-dropdown',
                        type: 'select',
                        relatedEditableProperties: 'buttons.text',
                        relatedCSSProperties: ['font-weight', 'font-style'],
                        pffSettings: prx.commonproperties.pffSettingsTextFontStyle,
                        value: function (item, name) {
                            return typeof item.dropdownTextFontStyle == 'undefined' ? item.textFontStyle : item.dropdownTextFontStyle;
                        },
                        values: function () {
                            return prx.comps.fontStyles
                        },
                ...
                [
                    {
                        ...
                        , changeProperty: {
                            ...
                            changeFunction: function (item, containerid) {
                                let id = (!containerid) ? item.id : containerid + '-' + item.id;
                                let cssSelector = '#' + id + ' .metro-dropdown-contextmenu';
                ...
                [
                    {
                        ...
                        type: 'select',
                        value: function (item, name) {
                            return item.activeTextFont === undefined ? item.textFont : item.activeTextFont;
                        },
                        values: function () {
                            return prx.comps.fonts
                        }
                        , changeProperty: {
                            caption: 'Active text Font',
                            property: 'font-family',
                            selector: '.changeProperty-activeTextFont',
                            transitionable: true
                        }
                    }
                ],
                [
                    {
                        ...
                        pffSettings: prx.commonproperties.pffSettingsTextFontStyle,
                        value: function (item, name) {
                            return typeof item.activeTextFontStyle == 'undefined' ? item.textFontStyle : item.activeTextFontStyle;
                        },
                        values: function () {
                            return prx.comps.fontStyles
                        },
                        ...
                        , changeProperty: {
                            caption: 'Active font Style',
                            property: 'font-style',
                            selector: '.changeProperty-activeTextFontStyle',
                            transitionable: true
                        }
                    }
                ],
                [
                    {
                        ...
                        , changeProperty: {
                            ...
                            changeFunction: function (item, containerid) {
                                let id = (!containerid) ? item.id : containerid + '-' + item.id;
                                //selected
                                let cssSelector = '#' + id + ' .metro-dropdown-active-value';
                                //selection in dropdown
                                let cssSelector2 = '#' + id + ' .metro-dropdown-item.active';

                                prx.componentsHelper.addStyleForChangeFunction(id, id + '-dropdownTextProperties', cssSelector, '', item.activeTextProperties, 'props-text');
                                prx.componentsHelper.addStyleForChangeFunction(id, id + '-dropdownTextProperties2', cssSelector2, '', item.activeTextProperties, 'props-text');
                            }
                        }
                    },
                    {
                ...
                [
                    {
                        ...
                        , values: function (item, name) {
                            ...
                            for (var n = 0; n < item.buttons.length; n++) {
                                _rA.push({
                                    value: n,
                                    displayValue: prx.componentsHelper.getProp(item.buttons[n].text, 'text-textarea')
                                });
                            }
                            return _rA;
                        }
                        , changeProperty: {
                            ...
                            changeFunction(item, containerid) {
                                let id = (!containerid) ? item.id : containerid + '-' + item.id;
                                let cssSelector = '#' + id + ' .metro-dropdown-item';
                                ...
                                $.each(items, function (index, _item) {
                                    ...
                                    if (index === parseInt(item.selected)) {
                                        ...
                                        $('#' + id).find('.metro-dropdown-active-value').text($(_item).find('span').text());
                                    }
                                });
                            }
                ...
                [
                    {
                        ...
                        , changeProperty: {
                            ...
                            changeFunction(item, containerid) {
                                let id = (!containerid) ? item.id : containerid + '-' + item.id;
                                let cssSelector = '#' + id + ' .dropdown-trigger';
...
prx.componentsHelper.removeProperties(prx.types.metro_dropdown.propertyGroups, ['activeTextColor', 'activeTextFont', 'activeTextProperties', 'activeTextFontStyle', 'activeTextProperties', 'selected']);
...
prx.types.metro_dialog = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos liveUpdate-textColor-color type-metro-dialog type-metro-dialog-'+prx.componentsHelper.getProp(item.alertType,'other')+'  changeProperty-textFont changeProperty-textColor changeProperty-textSize changeProperty-textAlign">';

        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#'+_id+' { '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' '+_props+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+'; }';
        cR += '#'+_id+' .type-metro-dialog-inner { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; border: '+prx.componentsHelper.getProp(item.buttonBorderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.buttonBorderColor,'color-border')+'; }'
		...
		cR += '<div class="type-metro-dialog-inner liveUpdate-backgroundColor-background-color liveUpdate-buttonBorderColor-border-color liveUpdate-buttonBorderWidth changeProperty-backgroundColor changeProperty-buttonBorderColor changeProperty-buttonBorderWidth">';
		...
		$.each(item.buttons, function(i,elm){
			cButtons += '<div class="metro-dialog-button dynamic-property liveUpdate-buttonBackgroundColor-background-color liveUpdate-buttonBorderColor-border-color liveUpdate-buttonBorderWidth liveUpdate-buttonTextColor-color changeProperty-buttonBorderColor changeProperty-buttonBorderWidth " id="'+_id+'-buttons-'+i+'" data-dynamic-property-index="'+i+'">';
    ...
    ,propertyGroups: [
                ...
                [
                    ...
                    [
                    {
                        ...
                        ,changeProperty: {
                            ...
                            property: 'border-width',
                            selector: '.type-metro-dialog-inner,.metro-dialog-button',
                            transitionable: true
                        }
                    }
                    ,{
        ...
        ,{
            ...
            properties: [
                ...
                [
                    prx.commonproperties.textFontStyleRichText(['font-weight', 'font-style'],['text','title','buttons.text'], false, {propName: 'textFontStyle', caption: 'Text Font style', useAsDynProp: false}),
                    prx.commonproperties.textSizeRichText('font-size',['text','title','buttons.text'])
                ],
                [
                     prx.commonproperties.textPropertiesRichText(['font-weight','font-style','text-decoration'],['text','title','buttons.text'], false, {propName: 'textProperties', caption: 'Underline', useAsDynProp: false})
                ...
                [
                    {
                    caption: { label: 'Buttons', class: 'text-background-label' },
...
prx.types.metro_toast_mini = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#'+_id+' .metro-toast-mini-inner { line-height: '+_dims.height+'px; '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+';  '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px;  }';
        cR += '</style>';
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
...
prx.types.metro_toast = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#'+_id+' .metro-toast-inner { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+';  '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px;  }';
        if(prx.componentsHelper.getProp(item.imgSrc.fileId,'other') != '') {
		...
		cR += '<div class="metro-toast-inner liveUpdate-backgroundColor-background-color liveUpdate-textColor-color changeProperty-backgroundColor changeProperty-textColor changeProperty-textFont changeProperty-textSize">'
		if(prx.componentsHelper.getProp(item.imgSrc.fileId,'other') != '') {
    ...
    ,propertyGroups: [
        ...
        },
        {
            ...
            properties: [
                ...
                [
                     prx.commonproperties.textFontStyleRichText(['font-weight', 'font-style'],['text', 'title'], false, {propName: 'textFontStyle', caption: 'Font style', useAsDynProp: false})
                     ,prx.commonproperties.textSizeRichText('font-size',['text', 'title'])
                ],
                [
                     prx.commonproperties.textPropertiesRichText(['font-weight','font-style','text-decoration'],['text', 'title'], false, {propName: 'textProperties', caption: 'Underline', useAsDynProp: false})
...
prx.types.metro_tile_plain = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-metro-tile type-metro-tile-plain">';
        cR += '<div class="metro-tile-bg-wrapper liveUpdate-backgroundColor-background-color changeProperty-backgroundColor">'
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .metro-tile-bg-wrapper { width: 100%; height: 100%; '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; }';
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
		cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
		cR += '</div>';
...
prx.types.metro_tile_icon = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#'+_id+' .metro-tile-icon-inner { '+prx.utils.getBgCss(item.backgroundColor)+';  '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px;  }';
        if(prx.componentsHelper.getProp(item.imgSrc.fileId,'other') != '') {
            cR += '#'+_id+' .metro-tile-icon-image { background-image:  url('+prx.componentsHelper.getProp(item.imgSrc,'asset')+'); }'
        }
		...
		cR += '<div class="metro-tile-icon-inner liveUpdate-backgroundColor-background-color changeProperty-backgroundColor liveUpdate-textColor-color">';
        cR += '<div class="metro-tile-icon-image">';
    ...
    ,propertyGroups: [
        ...
        ,{
            ...
            properties: [
                ...
                [
                    prx.commonproperties.textFontStyleRichText(['font-weight', 'font-style'],['badgeNumber','brandingText'], function(item){return !(item.badgeType == 'number' || item.brandingType == 'text')}, {propName: 'textFontStyle', caption: 'Text Font style', useAsDynProp: false}),
                    {
                        caption:false,
                        name: 'textSize',
                        proptype: 'font-size',
                ...
                [
                    prx.commonproperties.textPropertiesRichText(['font-weight','font-style','text-decoration'],['badgeNumber','brandingText'], function(item){return !(item.badgeType == 'number' || item.brandingType == 'text')}, {propName: 'textProperties', caption: 'Underline', useAsDynProp: false})
                    ,{
                    caption: { label: 'Color', class: 'text-properties-label text-color-label' },
                    name: 'textColor',
                    proptype: 'font-color',
                ...
                [
                    {
                        ...
                        ,onChange: function(item,name) {
                            if(item.brandingType == 'text' || item.badgeType == 'number') {
                                $('#property-textSize, #property-textFont, #property-textFontStyle, #propert-textProperties, #property-textColor').show()
                            } else {
                                $('#property-textSize, #property-textFont, #property-textFontStyle, #propert-textProperties, #property-textColor').hide()
                            }
...
prx.types.metro_tile_image = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '#'+_id+' .metro-tile-image-inner { '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px;  }';
        cR += '#'+_id+' .metro-tile-image-inner-bg { width: 100%; height: 100%;  }';

		cR += '#'+_id+' .metro-tile-caption { '+prx.gradients.getBgCssByProperty(item.badgeBackgroundColor,'color-background')+'; }';
		cR += '#'+_id+' .metro-tile-badge-bg { '+prx.gradients.getBgCssByProperty(item.badgeBackgroundColor,'color-background')+'; }';
        if(prx.componentsHelper.getProp(item.imgSrc.fileId,'other') != '') {
		...
		if(prx.componentsHelper.getProp(item.withCaption,'boolean')) {
			cR += '<div class="metro-tile-inner-bg">';
			cR += '<div class="metro-tile-caption liveUpdate-badgeBackgroundColor-background-color changeProperty-badgeBackgroundColor">';
		}
		cR += '<div class="metro-tile-branding liveUpdate-textColor-color metro-tile-branding-'+prx.componentsHelper.getProp(item.brandingType,'other')+'">';
		if(prx.componentsHelper.getProp(item.brandingType,'other') == 'text') {
			//cR += item.brandingText;
			cR += '<span data-editableproperty="brandingText">'+prx.componentsHelper.getProp(item.brandingText,'text-textarea')+'</span>';
		}
		cR += '</div>';
		cR += '<div class="metro-tile-badge liveUpdate-textColor-color metro-tile-badge-'+prx.componentsHelper.getProp(item.badgeType,'other')+'">';
        if(!prx.componentsHelper.getProp(item.withCaption,'boolean')) {
            cR += '<div class="metro-tile-badge-bg liveUpdate-badgeBackgroundColor-background-color changeProperty-badgeBackgroundColor">';
        }
        else {
            cR += '<div class="metro-tile-badge-padding">';
        }
		if(prx.componentsHelper.getProp(item.badgeType,'other') == 'number') {
			//cR += item.badgeNumber;
			cR += '<span data-editableproperty="badgeNumber">'+prx.componentsHelper.getProp(item.badgeNumber,'text-textarea')+'</span>';
		}
        cR += '</div>'; // closes .metro-tile-badge-bg or .metro-tile-badge-padding
		cR += '</div>'; // closes .metro-tile-badge
		if(prx.componentsHelper.getProp(item.withCaption,'boolean')) {
			cR += '<div class="metro-tile-caption-text liveUpdate-textColor-color">';
			cR += '<span data-editableproperty="text">'+prx.componentsHelper.getProp(item.text,'text-textarea')+'</span>';

            cR += '</div>'; // closes .metro-tile-caption-text
            cR += '</div>'; // closes .metro-tile-caption
			cR += '</div>'; // closes .metro-tile-inner-bg
        }
        cR += '</div>'; // closes .metro-tile-image-inner
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
        cR += '</div>';
        return cR;
    }
    ...
    ,propertyGroups: [
        ...
        ,
        {
            ...
            properties: [
                ...
                [
                    prx.commonproperties.textFontStyleRichText(['font-weight', 'font-style'],['text','badgeNumber'], function(item){ if(item.withCaption) { return false; } return !(item.badgeType == 'number' || item.brandingType == 'text')}, {propName: 'textFontStyle', caption: 'Text Font style', useAsDynProp: false}),
                    {
                    caption: false,
                    name: 'textSize',
                    proptype: 'font-size',
                    ...
                    [
                    prx.commonproperties.textPropertiesRichText(['font-weight','font-style','text-decoration'],['text','badgeNumber'], function(item){ if(item.withCaption) { return false; } return !(item.badgeType == 'number' || item.brandingType == 'text')}, {propName: 'textProperties', caption: 'Underline', useAsDynProp: false})
                    ,{
                    caption: { label: 'Color', class: 'text-properties-label text-color-label' },
                    name: 'textColor',
                    proptype: 'font-color',
...
prx.types.metro_tile_text = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#'+_id+' .metro-tile-text-inner { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+';  '+ prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle) +' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+item.textSize+'px;  }';
        if(prx.componentsHelper.getProp(item.imgSrc.fileId,'other') != '') {
		...
		cR += '<div class="metro-tile-text-inner liveUpdate-backgroundColor-background-color liveUpdate-textColor-color">';
		if(prx.componentsHelper.getProp(item.imgSrc.fileId,'other') != '') {
    ...
    ,propertyGroups: [
        {
            ...
            properties: [
                ...
                [
                    prx.commonproperties.textFontStyleRichText(['font-weight', 'font-style'],['text','title','badgeNumber','brandingText'], false, {propName: 'textFontStyle', caption: 'Font style', useAsDynProp: false}),
                    {
                        caption: false,
                        name: 'textSize',
                        proptype: 'font-size',
                ...
                [
                    prx.commonproperties.textPropertiesRichText(['font-weight','font-style','text-decoration'],['text','title','badgeNumber','brandingText'], false, {propName: 'textProperties', caption: 'Underline', useAsDynProp: false})
                    ,{
                    caption: { label: 'Color', class: 'text-properties-label text-color-label' },
                    name: 'textColor',
                    proptype: 'font-color',
...
prx.types.metro_textfield = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        if(prx.editor) {
            cR += '<div class="faux-input liveUpdate-textColor-color liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color" data-editableproperty="value"  style="color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' border: '+prx.componentsHelper.getProp(item.borderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; '+ _props + '; '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+'; line-height: '+(_dims.height-parseInt(prx.componentsHelper.getProp(item.borderWidth,'num-border-width'))*2)+'px;">'+prx.componentsHelper.getProp(item.value,'text')+'</div>';
            cR += '<div class="faux-input placeholder-input liveUpdate-placeholderColor-color liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color"  style="color: '+prx.componentsHelper.getProp(item.placeholderColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' border: '+prx.componentsHelper.getProp(item.borderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; '+ _props + '; '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+'; line-height: '+(_dims.height-parseInt(prx.componentsHelper.getProp(item.borderWidth,'num-border-width'))*2)+'px;">'+prx.componentsHelper.getProp(item.placeholder,'other')+'</div>'
        } else {
            cR += '<input autocomplete="new-password" data-lpignore="true" type="'+prx.componentsHelper.getProp(item.inputtype,'other')+'" value="'+prx.componentsHelper.getProp(item.value,'other')+'" placeholder="'+prx.componentsHelper.getProp(item.placeholder,'other')+'" data-role="none" class="real-input changeProperty-backgroundColor changeProperty-textSize changeProperty-fontStyle changeProperty-textColor changeProperty-textFont changeProperty-borderWidth changeProperty-borderColor changeProperty-textAlign" style="color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' border: '+prx.componentsHelper.getProp(item.borderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; '+ _props + '; '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+';" />'
        }
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
        cR += '</div>';
        return cR;
                ...
                [
                    {
                        ...
                        ,changeProperty: {
                            ...
                            changeFunction(item, containerid) {
                                ...
                                if (prx.editor) {
                                    prx.componentsHelper.addStyleForChangeFunction(id, id + '-borderWidth', cssSelector + ' .faux-input', 'border-width', item.borderWidth,'border-width', true);
                                } else {
                                    prx.componentsHelper.addStyleForChangeFunction(id, id + '-borderWidth', cssSelector  + ' input.real-input.changeProperty-borderWidth', 'border-width', item.borderWidth,'border-width', true);
                                }
                            }
                        }
                    }
...
prx.types.metro_textarea = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
        if(prx.editor) {
            cR += '<div class="faux-input liveUpdate-textColor-color liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color" data-editableproperty="value"  style="color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' border: '+prx.componentsHelper.getProp(item.borderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; '+ _props + '; '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+';">'+prx.componentsHelper.getProp(item.value,'text-textarea')+'</div>';
            cR += '<div class="faux-input placeholder-input liveUpdate-placeholderColor-color liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color"  style="color: '+prx.componentsHelper.getProp(item.placeholderColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' border: '+prx.componentsHelper.getProp(item.borderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; '+ _props + '; '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+';">'+prx.componentsHelper.getProp(item.placeholder,'other')+'</div>'
        } else {
            cR += '<textarea class="changeProperty-textColor changeProperty-textSize changeProperty-textFont changeProperty-textFontStyle changeProperty-backgroundColor changeProperty-textAlign changeProperty-borderWidth changeProperty-borderColor liveUpdate-placeholderColor-color liveUpdate-textColor-color liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color" placeholder="'+prx.componentsHelper.getProp(item.placeholder,'other')+'" style="color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' border: '+prx.componentsHelper.getProp(item.borderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; '+ _props + '; '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+';" data-role="none">'+prx.componentsHelper.getProp(item.value,'text-textarea').replace(/<br \/>/g, "\n")+'</textarea>';
        }
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
        cR += '</div>';
        return cR;
...
prx.types.metro_radiobutton = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
		...
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
		cR += '<input type="'+_type+'" '+_active+ ' id="'+_id+'-checkbox" data-role="none"  ' + radioButtonsGroupName + '/>';
		cR += '<label class="liveUpdate-backgroundColor-background-color liveUpdate-borderColor-border-color changeProperty-backgroundColor changeProperty-borderWidth changeProperty-borderColor" for="'+_id+'-checkbox" data-clickable="true"><span  class="liveUpdate-activeColor-background-color changeProperty-activeColor"></span></label>';
    ...
    ,afterDisplay: function(item,containerid,symbol) {
		...
		if(!prx.editor) {
            ...
            if(_isCheckboxAndRadioGrouped) {
                ...
                $('label[for="'+_id+'-checkbox"]').hammer().on('click tap change', function(event) {
                    event.preventDefault();
                });
...
prx.types.metro_checkbox = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<label for="'+_id+'-checkbox" class="liveUpdate-backgroundColor-background-color liveUpdate-borderColor-border-color changeProperty-backgroundColor changeProperty-borderWidth changeProperty-borderColor" data-clickable="true"><span class="liveUpdate-activeColor-color changeProperty-activeColor">&#10004;</span></label>';
		cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
		cR += '</div>';
		return cR;
	}
...
prx.types.metro_onoff = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<input type="'+_type+'" '+_active+ ' id="'+_id+'-flipswitch" data-role="none" ' + radioButtonsGroupName + ' />';
		cR += '<label for="'+_id+'-flipswitch" class="liveUpdate-borderColor-border-color" data-clickable="true">';
		cR += '<div class="flipswitch-inner">'
		cR += '<span class="activelabel liveUpdate-activeLabelColor-background-color"></span>';
		cR += '<span class="inactivelabel liveUpdate-inactiveLabelColor-background-color"></span>';
		cR += '</div>';
		cR += '<span class="switch liveUpdate-switchColor-background-color"></span>';
		cR += '</label>';
		cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
		cR += '</div>';
		return cR;
	...
	,afterDisplay: function(item,containerid,symbol) {
		...
		if(!prx.editor) {
			...
			if(_isCheckboxAndRadioGrouped) {
                ...
                $('label[for="'+_id+'-flipswitch"]').hammer().on('click tap', function(event) {
                    event.preventDefault();
                });

                $('#'+_id+'-flipswitch').on('change', function(event) {
                    event.preventDefault();
                });
            }
...
prx.types.metro_slider = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
		...
		if(prx.componentsHelper.getProp(item.hasRange,'boolean')) {
			cR += '<span class="slider-button slider-button-min liveUpdate-sliderColor-background-color"></span>';
		}
		cR += '<span class="slider-button slider-button-max liveUpdate-sliderColor-background-color"></span>';
		cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
		cR += '</div>';
		return cR;
...
prx.types.metro_progress = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-metro-progress liveUpdate-barColor-background-color">';
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
...
prx.types.metro_select = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-metro-select liveUpdate-textColor-color">';

        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#'+_id+' { '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' '+_props+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; }';
        cR += '#'+_id+' .dropdown-trigger { line-height: '+(_dims.height-prx.componentsHelper.getProp(item.borderWidth,'num-border-width')*2)+'px; }'
        cR += '#'+_id+' .dropdown-trigger, #'+_id+' .metro-dropdown-contextmenu { border: '+prx.componentsHelper.getProp(item.borderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; }';
        ...
        cR += '<div class="dropdown-trigger liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color ">'
        cR += '<span class="metro-dropdown-active-value changeProperty-backgroundColor changeProperty-textColor">';
        cR += (typeof(item.buttons[item.selected]) != "undefined") ? prx.componentsHelper.getProp(item.buttons[item.selected].text,'text-textarea') : ((typeof(item.buttons[0]) != "undefined") ? prx.componentsHelper.getProp(item.buttons[0].text,'text-textarea') : '');
        cR += '</span>';
        cR += '<div class="dropdown-trigger-icon"></div>'
        cR += '</div>'
        cR += '<div class="metro-dropdown-contextmenu liveUpdate-backgroundColor-background-color liveUpdate-borderColor-border-color changeProperty-backgroundColor changeProperty-textColor changeProperty-textSize changeProperty-textFont changeProperty-textFontStyle">'
        $.each(item.buttons, function(i,elm){
    ...
    ,propertyGroups: [
                ...
                [
                        {
                              ...
                              ,changeProperty: {
                                ...
                                changeFunction(item, containerid) {
                                    let id = (!containerid) ? item.id : containerid + '-' + item.id;
                                    let cssSelector = '#' + id + ' .dropdown-trigger-icon';
        ...
        },
        {
            ...
            properties: [
                ...
                [
                    prx.commonproperties.textFontStyleRichText(['font-weight', 'font-style'],['text', 'buttons.text'], false, {propName: 'textFontStyle', caption: 'Font style', useAsDynProp: false}),
                    prx.commonproperties.textSizeRichText('font-size',['text', 'buttons.text'])
                ],
                [
                     prx.commonproperties.textPropertiesRichText(['font-weight','font-style','text-decoration'],['text', 'buttons.text'], false, {propName: 'textProperties', caption: 'Underline', useAsDynProp: false})
         ...
         ,editableProperties:[
            {
                ...
                ,changeProperty: {
                    caption: 'Text',
                    transitionable: false,
                    selector: '.metro-dropdown-item,.metro-dropdown-active-value', //do not delete, even it is rerender we need this for the changetextprop and changetextfont style functions
                    changeFunction(item, containerid) {
                        let id = (!containerid) ? item.id : containerid + '-' + item.id;
                        let cssSelector = '#' + id + ' .metro-dropdown-item .error-msg span';
...
prx.components.metro_tile_systeminfo = {
    ...
    ,resizable : false
    ,properties: "v,l,hpos,vpos,o,dr,f,ds"
};
...
prx.components.metro_appbar = {
    ...
    ,resizable : true
    ,resizeHandles : "e,w"
    ,properties: "v,l,hpos,vpos,w,o,r,dr,f,ds"
...
prx.components.metro_filters = {
    ...
    ,textColor:  '000000'
    ,textProperties: []
    ,activeTextFont: 'Segoe UI, sans-serif'
    ,activeTextFontStyle: '400'
